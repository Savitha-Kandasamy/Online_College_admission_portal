            ...
            <div className={`collapse navbar-collapse ${menuOpen ? 'show' : ''}`}>
              <ul className="navbar-nav "> {/* Center-align links */}
                <li className="nav-item">
                  <NavLink className="nav-link" to="/AdminHome" onClick={() => setMenuOpen(false)}>
                     Home
                  </NavLink>
                </li>
                <li className="nav-item">
                  <NavLink className="nav-link" to="/AdminAbout" onClick={() => setMenuOpen(false)}>
                     About Us
                  </NavLink>
                </li>
                <li className="nav-item">
                  <NavLink className="nav-link" to="/AdminInstitute" onClick={() => setMenuOpen(false)}>
                    Find a College
                  </NavLink>
                </li>
                <li className="nav-item">
